...
namespace DapperWith4DatabaseCommunication.Repositories
{
    ...
    { 
        ...
        public async Task<int> AddOrder(Orders orderdetail)
        {
            ...
            await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: AddOrder method Excution Starts");//logg the message in database using custom logging factory
            ...
            {//Create object for DynamicParameters for storedure input parameter values binding purpose used.
                ...
                await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: AddOrder method Excution Ended");//logg the message in database using custom logging factory

                Log.Information("OrdersRepository: AddOrder method Excution Ended and Insertedrecord is{@Insertedrecord}", inserterdid);
                await _loggingFactory.AddLoggingMessages("venkat", "Information", $"OrdersRepository: AddOrder method Excution Ended and Insertedrecord is {inserterdid}");//logg the message in database using custom logging factory
                return inserterdid;
            }
        ...
        public async Task<string> DeleteOrderById(int orderid)
        {
            ...
            await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: DeleteOrderById method Excution Starts");//logg the message in database using custom logging factory
            ...
            using (IDbConnection con = _connectionFactory.MidLandSqlConnectionString())
            {
                ...
                else
                {
                    ...
                    await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: DeleteOrderById method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<Orders> GetOrderById(int orderid)
        {
            ...
            await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: GetOrderById method Excution Starts");//logg the message in database using custom logging factory
            ...
            using (IDbConnection con = _connectionFactory.MidLandSqlConnectionString())
            {
                ...
                await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: GetOrderById method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<List<Orders>> GetOrders()
        {
            ...
            await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: GetOrders method Excution Starts");//logg the message in database using custom logging factory
            ...
            using (IDbConnection conn = _connectionFactory.MidLandSqlConnectionString())
            {
                ...
                await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: GetOrders method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<string> UpdateOrder(Orders orderdetail)
        {
            ...
            await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository:UpdateOrder method Excution Starts");//logg the message in database using custom logging factory
            ...
            using (IDbConnection con = _connectionFactory.MidLandSqlConnectionString())
            {
                ...
                else
                {
                    ...
                    await _loggingFactory.AddLoggingMessages("venkat", "Information", "OrdersRepository: UpdateOrder method Excution Ended");//logg the message in database using custom logging factory
