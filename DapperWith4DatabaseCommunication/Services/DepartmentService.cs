...
namespace DapperWith4DatabaseCommunication.Services
{
    public class DepartmentService : IDepartmentService
    {
        ...
        public async Task<int> AddDepartment(DepartmentDto deptdetail)
        {
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: AddDepartment method Excution Starts");//logg the message in database using custom logging factory
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: AddDepartment method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<string> DeleteDepartment(int departmentid)
        {
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: DeleteDepartment method Excution Starts");//logg the message in database using custom logging factory
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: DeleteDepartment method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<DepartmentDto> GetDepartmentById(int deptid)
        {
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: GetDepartmentById method Excution Starts");//logg the message in database using custom logging factory
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService:GetDepartmentById method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<List<DepartmentDto>> GetDepartments()
        {
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: GetDepartments method Excution Starts");//logg the message in database using custom logging factory
            ...
            foreach (Department dept in res)
            {
                ...
                await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: GetDepartments method Excution Ended");//logg the message in database using custom logging factory
        ...
        public async Task<string> UpdateDepartment(DepartmentDto deptdetail)
        {
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: UpdateDepartment method Excution Starts");//logg the message in database using custom logging factory
            ...
            await _loggingFactory.Add_DepartmentLoggingMessages("venkat", "Information", "DepartmentService: UpdateDepartment method Excution Ended");//logg the message in database using custom logging factory
